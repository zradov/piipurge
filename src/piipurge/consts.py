...
HANDWRITTEN_SIGNATURES_MODEL_PATH = Path(MODELS_FOLDER).joinpath("handwrittings_classification_model.joblib")
REPLACEMENT_FONTS_PATH = DATA_FOLDER.joinpath("font_replacements.csv")

_ = [d.mkdir(parents=True, exist_ok=True) for d in [
    DATA_FOLDER, OUTPUT_FOLDER, ACRONYMS_TRAINING_FOLDER, SPANCAT_NER_TRAINING_FOLDER
]]
